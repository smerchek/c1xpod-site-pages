    ...
    >
      <Container>
        <div className="flex flex-col items-start">
          ...
          />
          <p className="mt-1 text-base leading-7 text-slate-700 prose">
            {episode.content_text.split("\n\n")[0]}
          </p>
          <div className="mt-4 flex items-center gap-4">
            <EpisodePlayButton
              episode={episode}
              className="flex items-center gap-x-3 text-sm font-bold leading-6 text-slate-500 hover:text-slate-700 active:text-slate-900"
              playing={
                <>
