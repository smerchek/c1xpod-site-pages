...
export const links: LinksFunction = () => [
  { rel: "preconnect", href: "hhttps://cdn.fontshare.com" },
  {
    rel: "stylesheet",
...
export const meta: MetaFunction = () => {
  return [
    { title: "C1X Disc Golf Podcast" },
    {
      name: "description",
      content: "A podcast about disc golf culture and the people who drive it.",
    },
    {
      property: "og:title",
      content: "C1X Disc Golf Podcast",
    },
    {
...
function MainLayout() {
  const hosts = ["Bren Orwig", "Scott Smerchek"];

  return (
    <div className="w-full">
      <AudioProvider>
        <header className="bg-[#08CAA4] bg-opacity-20 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
          ...
          <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-3xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:px-8 lg:py-12 xl:px-12">
            <Link
              to="/"
            ...
            <div className="mt-10 text-center lg:mt-12 lg:text-left">
              <p className="text-xl font-bold text-slate-900">
                <Link to="/">C1X Disc Golf Podcast</Link>
              </p>
              <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
                Exploring disc golf culture and the people who drive it.
              </p>
            </div>
                ...
                {(
                  [
                    ...
                    [
                      "Overcast",
                      OvercastIcon,
                      "https://overcast.fm/itunes1791326511",
                    ],
...
export function ErrorBoundary() {
  ...
  if (isRouteErrorResponse(error)) {
    return (
      <>
        <main className="w-full relative flex h-full items-center py-36 lg:px-8">
          <Waveform className="absolute left-0 top-0 h-20 w-full" />
  ...
  return (
    <main className="w-full relative flex h-full items-center py-36 lg:px-8">
      <Waveform className="absolute left-0 top-0 h-20 w-full" />
      <div className="relative mx-auto flex w-full max-w-2xl flex-col items-center px-4 sm:px-6 lg:px-0">
        <h1 className="mt-4 text-lg font-bold text-slate-900">Oh no!</h1>
        <p className="mt-2 text-base leading-7 text-slate-700">
          Sorry, something went wrong.
        </p>
        <Link
